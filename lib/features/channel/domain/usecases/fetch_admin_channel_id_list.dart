...
class FetchAdminChannelIdList implements AsyncEitherUsecase<List<String>, UserAuth>{
  final ChannelRepo _channelRepo;

  FetchAdminChannelIdList(this._channelRepo);

  @override
  Future<Either<DataCRUDFailure, List<String>>> call(UserAuth params) async{
    return await _channelRepo.adminChannelIdList(userAuth: params);
  }
