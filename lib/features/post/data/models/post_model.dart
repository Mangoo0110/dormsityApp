...
class PostModel extends Post{
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'docId': docId,
      'postMetaData': PostMetaDataModel.fromEntity(postMetaData),
  ...
  @override
  String toString() {
    return 'Post(docId: $docId, channelId: $postMetaData, postType: $postType, createdBy: $createdBy, createdAt: $createdAt, lastEditAt: $lastEditAt, textContent: $textContent, imageContentUrls: $imageContentUrls, upVote: $upVote, impression: $impression, commentCount: $commentCount, upVoted: $upVoted, downVoted: $downVoted)';
  }
